...
2 for Mike. `docker run -e ALCHE_API="https://eth-mainnet.g.alchemy.com/v2/bPRJfWCsPb6jB2XzLv_j5kTAgnSUSCt2" -it defi-mooc-lab2 npm test`
2 for Stone. `docker run -e ALCHE_API="https://eth-mainnet.g.alchemy.com/v2/M1vtogRKwxtMHDtaXFfSexwOAh_Q89ee" -it defi-mooc-lab2 npm test`
2 for Stone 2. `docker run -e ALCHE_API="https://eth-mainnet.g.alchemy.com/v2/jnXpLacOLhJrJLCv8glannTe4SWnxAjd" -it defi-mooc-lab2 npm test`
